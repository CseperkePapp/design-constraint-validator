...
| 004 | [DCV v2.1.0 — make the published package usable (CLAUDE)](TASK-004-CLAUDE-dcv-fix-tokens-flag-and-readme.md) | P1 | todo |
| 005 | [Fix OKLCH→sRGB conversion (CODEX)](TASK-005-CODEX-dcv-oklch-contrast-bug.md) | P1 | todo |
| 006 | [Diagnose & fix silent release pipeline (CODEX)](TASK-006-CODEX-dcv-publish-pipeline.md) | P1 | todo |
| 007 | [Repo hygiene — de-commit build artifacts (CODEX)](TASK-007-CODEX-dcv-repo-hygiene.md) | P2 | todo |
